...
class SignModel(nn.Module):
    ...
    def run_batch(
        ...
        encoder_output1, encoder_hidden = self.encode(
            sgn=batch.sgn, sgn_mask=batch_ground.sgn_mask, sgn_length=batch_ground.sgn_lengths
        )
        ...
        return decoded_gloss_sequences, stacked_txt_output, stacked_attention_scores, encoder_output1, encoder_output_ground, sgn.view(sgn.shape[0], sgn.shape[1], 50, 3), sgn_ground.view(sgn_ground.shape[0], sgn_ground.shape[1], 50, 3)
